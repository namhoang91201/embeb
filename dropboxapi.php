	...
	<script>
			...
			player.setup({
			  sources: [ {
					...
					file: "https://dl.dropboxusercontent.com/s/<?=$_GET['id']?>?dl=0", label: "720p",
					type: "video/mp4"
					},{
					file: "https://dl.dropboxusercontent.com/s/<?=$_GET['id']?>?dl=0", label: "1080p",
					type: "video/mp4"
					}
			  ],
			  autostart: false,      
			  playbackRateControls: [0.25, 0.5, 0.75, 1, 1.25, 1.5, 2],   
			  abouttext: "DropBoxAPI", 
			  	 	  aboutlink: "",         

...
<body>
	<iframe src="<?=$_GET['id']?>?title=0&byline=0&portrait=0&sidedock=0" scrolling="no" frameborder="0" width="100%" height="100%" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
